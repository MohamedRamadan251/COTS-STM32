...
void MRCC_voidSetPLLConfigurations(void)
{
	...
	RCC->RCC_PLLCFGR=(u32)((PLLM_BIT0<<0)|(PLLM_BIT1<<1)|(PLLM_BIT2<<2)|(PLLM_BIT3<<3)|(PLLM_BIT4<<4)|(PLLM_BIT5<<5)|
	(PLLN_BIT0<<6)|(PLLN_BIT1<<7)|(PLLN_BIT2<<8)|(PLLN_BIT3<<9)|(PLLN_BIT4<<10)|(PLLN_BIT5<<11)|
	(PLLN_BIT6<<12)|(PLLN_BIT7<<13)|(PLLN_BIT8<<14)|(PLLP_BIT0<<16)|(PLLP_BIT1<<17)|(PLL_Source<<22)|
	(PLLQ_BIT0<<24)|(PLLQ_BIT1<<25)|(PLLQ_BIT2<<26)|(PLLQ_BIT3<<27)|(PLLR_BIT0<<28)|(PLLR_BIT0<<29)|(PLLR_BIT0<<30));
}
