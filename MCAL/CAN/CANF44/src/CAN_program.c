 ...
 * This file provides Six functions to be called from user application and Ten Private Functions.
 ...
 *                            			     the "main.c" file.
 * 3- MCAN_voidReadMessage(CAN_Msg *msg, u8 Copy_u8FIFONumber) :-This Function Read message from Specific FIFO after the Message
 ...
 *										       This call is made inside the "main.c" file and it is used in Send Message Function.
...
#define GPIO_AFRH_AFRH11                     ((u32) 0x0000F000)
#define GPIO_AFRH_AFRH11_AF9                 ((u32) 0x00009000)
#define GPIO_AFRH_AFRH12                     ((u32) 0x000F0000)
#define GPIO_AFRH_AFRH12_AF9                 ((u32) 0x00090000)
...
//	/*********************************************/
////	MGPIO_ErrorStatusSetPinMode(Can_Tx,Output2_AFPushPull);  //Set TX pin to Alternative Function Pushpull
////	MGPIO_ErrorStatusSetPinMode(Can_Rx,Input_Floating);      //Set RX pin to Input Floating
//	MGPIO_voidSetPinOutputOrAF(PORTA, PIN12, AF, PUSH_PULL, FAST_SPEED);
//	MGPIO_voidSetPinInput(PORTA, PIN11, AF, PULL_UP);
//	MGPIO_voidSetPinInput(PORTA, PIN12, AF, PULL_UP);
//
//	/*set AF for pin 8 & 9 port B for CAN*/
//	SET_BIT(GPIOA->GPIOx_AFRH,12);
//	SET_BIT(GPIOA->GPIOx_AFRH,15);
//	SET_BIT(GPIOA->GPIOx_AFRH,16);
//	SET_BIT(GPIOA->GPIOx_AFRH,19);

	 /* Select alternate function mode */
	  GPIOA->GPIOx_MODER &= ~(((u32)0x00C00000) | ((u32)0x03000000));
	  GPIOA->GPIOx_MODER |= (((u32)0x00800000) | ((u32)0x02000000));

	  /* Select output type push-pull */
	  GPIOA->GPIOx_OTYPER &= ~(((u32)0x00001000));

	  /* Select output speed medium */
	  GPIOA->GPIOx_OSPEEDER &= ~(((u32)0x03000000));
	  GPIOA->GPIOx_OSPEEDER |= (((u32)0x01000000));

	  /* Select pull up */
	  GPIOA->GPIOx_PUPDR &= ~(((u32)0x00C00000) | ((u32)0x03000000));
	  GPIOA->GPIOx_PUPDR |= (((u32)0x00400000) | ((u32)0x00400000));

	  /* Select AF9 */
	  GPIOA->GPIOx_AFRH &= ~(GPIO_AFRH_AFRH11 | GPIO_AFRH_AFRH12);
	  GPIOA->GPIOx_AFRH |= (GPIO_AFRH_AFRH11_AF9 | GPIO_AFRH_AFRH12_AF9);
